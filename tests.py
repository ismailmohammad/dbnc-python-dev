...
class testSampleData(unittest.TestCase):
    ...
    def test_csv_output(self):
        ...
        test_content = [['BEND PAWN & TRADING CO-LAPINE', '52504 U.S. 97',
                        'LA PINE', 'OR', '97739']]
    ...
    def test_address_query(self):
        """Test Address Lookup"""
        address = ['BEND PAWN & TRADING CO-LAPINE', '52504 U.S. 97', 'LA PINE',
                   'OR', '97739']
        scraper.query_address(address)
        self.assertEqual(address[5], False)
        address_true = ['CARDIOSTART RESALE THRIFT STR', '435 W CASCADE AVE',
                        'SISTERS', 'OR', '97759']
